function Api() {
  $.getJSON(
    "https://noembed.com/embed?url=https://www.youtube.com/watch?v=JGeig0gc1LE&ab_channel=MehendiScape",
    function (data) {
      advid(data);
    }
  );
  $.getJSON(
    "https://noembed.com/embed?url=https://www.youtube.com/watch?v=HfUaZaCabtE&ab_channel=MehendiScape",
    function (data) {
      advid(data);
    }
  );
  $.getJSON(
    "https://noembed.com/embed?url=https://www.youtube.com/watch?v=JbYepAVafjQ",
    function (data) {
      advid(data);
    }
  );
  $.getJSON(
    "https://noembed.com/embed?url=https://www.youtube.com/watch?v=eqiytMhlFbY&ab_channel=MehendiScape",
    function (data) {
      advid(data);
    }
  );
  $.getJSON(
    "https://noembed.com/embed?url=https://www.youtube.com/watch?v=OkThP0fmEo8&ab_channel=MehendiScape",
    function (data) {
      advid(data);
    }
  );
